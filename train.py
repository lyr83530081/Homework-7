...
dir_img = './data/rgb_images/'
#dir_mask = 'data/masks/'
dir_mask ='./data/semantic_annotations/gtLabels/'
...
def get_args():
    ...
    parser.add_argument('-l', '--learning-rate', metavar='LR', type=float, nargs='?', default=0.000002,
